  ...
  return (
    <>
      ...
      <nav className="flex items-center justify-between mx-auto container pt-8 relative z-20 2xl:px-4 xl:px-10 px-4 ">
        ...
        <div className=" lg:flex hidden ">
          <ul className="flex items-center gap-x-7 mr-10">
            <Link href="/contact">
              <li className={`text-xl cursor-pointer tracking-1 leading-5 text-center hover:text-white  ${router.asPath === "/contact" ? "text-white" : "text-gray-500"}  `}>Contact</li>
            </Link>
            <Link href="/contact#faq">
              <li className={`text-xl cursor-pointer tracking-1 leading-5 text-center hover:text-white  ${router.asPath === "/contact#faq" ? "text-white" : "text-gray-500"}  `}>FAQ</li>
            </Link>
            <Link href="/blog">
              <li className={`text-xl cursor-pointer tracking-1 leading-5 text-center hover:text-white  ${router.asPath === "/blog" ? "text-white" : "text-gray-500"}  `}>Blog</li>
            </Link>
          ...
          {/* Login */}
          <div >
            <ButtonWithBorder link={"/contact"} text={"Get Started"} h="h-[46px]" w="w-[120px]" />
          </div>
        </div>
      ...
      <nav className={`w-64 lg:hidden block bg-white top-0 z-[10000] fixed left-0 duration-300 ease-in-out h-screen p-3 transform ${nav ? `translate-x-0` : `-translate-x-full`}`}>
        ...
        <div className="mt-6" >
          <ButtonBg link={"/contact"} text={"Get Started"} h="h-[36px]" mainHome={false} />
        </div>
      </nav>
    </>
  );
