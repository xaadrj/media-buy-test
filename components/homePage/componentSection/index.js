...
function index() {
  return (
    <>
      <section id="about" className="xl:mt-[128px] mt-[96px] relative ">
        <img
            ...
            <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
              <div>
                <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-200 mt-6">
                  Cross-border overseas travel
                </p>
                <p className="font-normal text-base leading-6 text-gray-400 mt-6">
                  Cross-border e-commerce is a new foreign trade format that is
                  developing rapidly, has great potential, and has a strong
                  driving effect. Under the influence of the global COVID-19
                  epidemic, cross-border e-commerce has broken through time and
                  space constraints and reduced the intermediate links of trade.
                  It has not only expanded the development space of foreign
                  trade, but also become a new driving force for the stable
                  development of foreign trade in my country.
                </p>
              </div>
              <div>
                <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-200 mt-6">
                  Taking the game overseas
                </p>
                <p className="font-normal text-base leading-6 text-gray-400 mt-6">
                  Going overseas is expected to become an important second
                  growth curve for domestic game manufacturers. On the policy
                  side: (1) The issuance of version numbers has resumed, and the
                  number is on a tightening trend. The domestic game market is
                  facing high regulatory pressure, and manufacturers are seeking
                  to expand overseas to expand growth space. (2) Regulators
                  encourage excellent game products to “go global”, and the
                  domestic game industry is expected to take advantage of this
                  opportunity to become a forerunner in “cultural export”. The
                  overseas game market has vast space, and games going overseas
                  will make a difference. Revenue from overseas games maintains
                  healthy growth, and there is still room for improvement in
              ...
              <div className="sm:block hidden">
                ...
                <p className="font-normal text-base leading-6 text-gray-400 mt-6">
                  Online novel and comic apps are the most popular categories
                  for pan-entertainment apps going overseas in 2020-22. Women
                  are usually the main users of comic apps, but among the user
                  groups of online novel apps, male users account for a
                  relatively higher proportion. Strong willingness to pay in
                  overseas markets may mean higher average paying user income.
                </p>
              </div>
            </div>
          </div>
