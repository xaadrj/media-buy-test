...
function video() {
  return (
    <section className="2xl:px-4 xl:px-10 px-4 md:mt-24 mt-12">
      <div className="flex items-center justify-center mx-auto container md:w-[1980px] 2xl:w-[1280px] shadow-video w-full rounded-xl    relative z-[50] 2xl:h-[320px] lg:h-[320px] md:h-[320px] h-[120px] ">
