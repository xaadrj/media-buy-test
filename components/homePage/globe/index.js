    ...
    <>
      <section className="relative  overflow-hidden  xl:h-[532px] h-[350px] flex items-center justify-center -mt-2">
        ...
        <div className="mx-auto container relative z-20 py-24 flex flex-col items-center justify-center">
          <H2 ptagColor="text-gray-400" textColor={"text-gray-50"} headingTwo={"We Feel A Connection. Do You?"}  />
          ...
          <div className="mt-4">
            <ButtonWithBorder link="/contact" fs="text-[14px]" radius="rounded-lg" h="h-[46px]" w="w-[164px]" text=" Let’s connect!" />
          </div>
        </div>
      </section>
    </>
